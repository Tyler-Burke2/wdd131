...
function ratingTemplate(rating) {
  // Begin building the HTML string using the ratings HTML written earlier as a model
  ...
  // Close the span tag for rating
  html += `</span>`;

  // Return the constructed HTML string for the rating
  return html;
}

const tags = ["dessert", "easy", "apple"];
...
function recipeTemplate(recipe) {
  return `<figure class="recipe">
		...
		<figcaption>
			...
			<p class="recipe__preptime">Prep Time: ${recipe.prepTime}</p>
...
function renderRecipes(recipeList) {
  ...
  // Loop through the recipe list and use recipeTemplate to generate HTML for each recipe
